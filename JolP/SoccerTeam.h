...
private:
  ...
  PlayerBase*               m_pPlayerClosestToBall2;
...
public:
  ...
  void                 SetPlayerClosestToBall2(PlayerBase* plyr){m_pPlayerClosestToBall2=plyr;}
  PlayerBase*          PlayerClosestToBall()const{return m_pPlayerClosestToBall;}
  PlayerBase*          PlayerClosestToBall2()const{return m_pPlayerClosestToBall2;}
